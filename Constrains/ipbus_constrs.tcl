...
create_clock -period 25 -name lhc_clk_40 -waveform {0.000 12.500} [get_ports FMC_HPC_CLK1_M2C_P]

# LHC clock 160 MHz from ADN2812 CDR on FMC TTC card
create_clock -period 6.25 -name lhc_clk_160 -waveform {0.000 3.125} [get_ports FMC_HPC_CLK0_M2C_P]
